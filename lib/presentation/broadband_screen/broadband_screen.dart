import 'bloc/broadband_bloc.dart';
import 'models/broadband_model.dart';
...
class BroadbandScreen extends StatelessWidget {
  BroadbandScreen({Key? key}) : super(key: key);

  GlobalKey<FormState> _formKey = GlobalKey<FormState>();

  static Widget builder(BuildContext context) {
    return BlocProvider<BroadbandBloc>(
        create: (context) =>
            BroadbandBloc(BroadbandState(broadbandModelObj: BroadbandModel()))
              ..add(BroadbandInitialEvent()),
        child: BroadbandScreen());
  }
    ...
    return SafeArea(
        child: Scaffold(
            ...
            appBar: AppBar(
                ...
                title:  Text( "lbl_broadband".tr,style: TextStyle(color: appTheme.white900),),
                actions: <Widget>[]
            ),
            body: SizedBox(
                width: 401.h,
    ...
    return Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Padding(
              ...
              child: BlocSelector<BroadbandBloc, BroadbandState,
    ...
    return Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Padding(
              padding: EdgeInsets.only(left: 2.h),
              child:
                  BlocSelector<BroadbandBloc, BroadbandState, BroadbandModel?>(
                      selector: (state) => state.broadbandModelObj,
                      builder: (context, broadbandModelObj) {
                        return CustomDropDown(
                            hintText: "lbl_select_operator".tr,
                            items: broadbandModelObj?.dropdownItemList ?? [],
                            onChanged: (value) {
                              context
                                  .read<BroadbandBloc>()
  ...
  Widget _buildFrameSixtySix(BuildContext context) {
    return Padding(
        ...
        child: Column(children: [
          ...
          SizedBox(height: 4.v),
          BlocSelector<BroadbandBloc, BroadbandState, TextEditingController?>(
